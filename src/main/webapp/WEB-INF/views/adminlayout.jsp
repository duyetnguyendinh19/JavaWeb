		...
		<div class="sidebar-toggle">
			<div id="mySidepanel" class="sidepanel">
				<a href="javascript:void(0)" class="closebtn" onclick="closeNav()"><i
					class="fa fa-arrow-left fa-lg" aria-hidden="true"></i></a>
				<div class="item-menu">
	...
	<div class="main-container" id="main-container">
		...
		<div id="sidebar" class="sidebar                  responsive">
			...
			<ul class="nav nav-list">
				...
				<li class=""><a href="admin/listcategory"> <i
						class="menu-icon fa fa-list-alt"></i> <span class="menu-text">
							Quan Ly PB </span>
				</a> <b class="arrow"></b></li>

				<li class=""><a href="admin/listProduct"> <i
						class="menu-icon fa fa-list-alt"></i> <span class="menu-text">
							Ly Lich NV </span>
				</a> <b class="arrow"></b></li>

				<li class=""><a href="admin/listUser"> <i
						class="menu-icon fa fa-list-alt"></i> <span class="menu-text">
							Quan Ly TK </span>
				</a> <b class="arrow"></b></li>
				<li class=""><a href="admin/kiluat"> <i
						class="menu-icon fa fa-list-alt"></i> <span class="menu-text">
							Kỉ Luật </span>
				</a> <b class="arrow"></b></li>
				<li class=""><a href="admin/Khenthuong"> <i
						class="menu-icon fa fa-list-alt"></i> <span class="menu-text">
							Khen Thưởng </span>
				</a> <b class="arrow"></b></li>
				<li class=""><a href="admin/hopdong"> <i
						class="menu-icon fa fa-list-alt"></i> <span class="menu-text">
							Hợp Đồng </span>
				</a> <b class="arrow"></b></li>
