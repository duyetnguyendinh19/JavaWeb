...
<link rel="icon"
	href="https://pbs.twimg.com/profile_images/807107466009792512/ouFeHHDj.jpg" />
		...
		<div class="navbar-container" id="navbar-container">
			...
			<div class="navbar-header pull-left">
				<a href="index.html" class="navbar-brand"> <small><i
						class="fa fa-leaf"></i> Ace Admin </small>
				</a>
			</div>
				...
				<ul class="nav ace-nav">
					...
					<li class="light-blue"><a data-toggle="dropdown" href="#"
						class="dropdown-toggle"> <img class="nav-user-photo"
							src="templates/avatars/user.jpg" alt="Jason's Photo" /> <span
