...
<head>
	...
	<link rel="stylesheet" href="templates/bootstrap-material-datetimepicker/css/bootstrap-material-datetimepicker.css"/>
	...
	<script src="templates/bootstrap-material-datetimepicker/js/bootstrap-material-datetimepicker.js"></script>
    <style>
        /*CSS Ảnh*/
        .wrap-custom-file {
            position: relative;
            ...
            <ul class="nav ace-nav">
                ...
                <li class="light-blue"><a data-toggle="dropdown"
                                          class="dropdown-toggle"> <img class="nav-user-photo"
                                                                        src="templates/avatars/user.jpg"/> <span
                        class="user-info">
