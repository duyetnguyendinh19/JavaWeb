	...
	<div class="main-container" id="main-container">
		...
		<div id="sidebar" class="sidebar responsive">
			...
			<ul class="nav nav-list">
				...
				<li
					class="${(fn:contains(requestScope['javax.servlet.forward.request_uri'] , 'Account')) ? 'active' : ''}"><a
				...
				<li
					class="${(fn:contains(requestScope['javax.servlet.forward.request_uri'] , 'Department')) ? 'active' : ''}"><a
				...
				<li
					class="${(fn:contains(requestScope['javax.servlet.forward.request_uri'] , 'Employee')) ? 'active' : ''}"><a
				...
				<li
					class="${(fn:contains(requestScope['javax.servlet.forward.request_uri'] , 'Contract')) ? 'active' : ''}"><a
					href="${pageContext.request.contextPath}/admin/listContract"> <i
						class="menu-icon fa fa-list-alt"></i> <span class="menu-text">
							Quản lý hợp đồng </span>
				</a> <b class="arrow"></b></li>
				<li
					class="${(fn:contains(requestScope['javax.servlet.forward.request_uri'] , 'Bonus')) ? 'active' : ''}"><a
					href="${pageContext.request.contextPath}/admin/listBonus"> <i
						class="menu-icon fa fa-list-alt"></i> <span class="menu-text">
							Quản lý khen thưởng</span>
				</a> <b class="arrow"></b></li>
				<li
					class="${(fn:contains(requestScope['javax.servlet.forward.request_uri'] , 'Discipline')) ? 'active' : ''}"><a
				...
				<li
					class="${(fn:contains(requestScope['javax.servlet.forward.request_uri'] , 'Attendance')) ? 'active' : ''}"><a
				...
				<li
					class="${(fn:contains(requestScope['javax.servlet.forward.request_uri'] , 'Salary')) ? 'active' : ''}"><a
