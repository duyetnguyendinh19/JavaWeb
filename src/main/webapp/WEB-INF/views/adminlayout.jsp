            ...
            <ul class="nav ace-nav">
                        ...
                        <li class="dropdown-content">
                            <ul class="dropdown-menu dropdown-navbar">
                                <li><a href="#" class="clearfix"> <img
                                        src="templates/avatars/avatar.png" class="msg-photo"
                                ...
                                <li><a href="#" class="clearfix"> <img
                                        src="templates/avatars/avatar3.png" class="msg-photo"
                                ...
                                <li><a href="#" class="clearfix"> <img
                                        src="templates/avatars/avatar4.png" class="msg-photo"
                                ...
                                <li><a href="#" class="clearfix"> <img
                                        src="templates/avatars/avatar2.png" class="msg-photo"
                                ...
                                <li><a href="#" class="clearfix"> <img
                                        src="templates/avatars/avatar5.png" class="msg-photo"
                ...
                <li class="light-blue"><a data-toggle="dropdown" href="#"
                                          class="dropdown-toggle"> <img class="nav-user-photo"
                                                                        src="templates/avatars/user.jpg"
...
<div class="main-container" id="main-container">
    ...
    <div id="sidebar" class="sidebar responsive">
        ...
        <ul class="nav nav-list">
            ...
            <li class=""><a href="${pageContext.request.contextPath}/admin/listProduct"> <i
                    class="menu-icon fa fa-list-alt"></i> <span class="menu-text">
							Quản lý nhân viên </span>
            </a> <b class="arrow"></b></li>

            <li class=""><a href="${pageContext.request.contextPath}/admin/listUser"> <i
                    class="menu-icon fa fa-list-alt"></i> <span class="menu-text">
