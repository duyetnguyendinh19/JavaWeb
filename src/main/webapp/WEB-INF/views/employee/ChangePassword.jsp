		...
		<div class="navbar-buttons navbar-header pull-right" role="navigation">
			<ul class="nav ace-nav">
				...
				<li class="light-blue"><a
					href="${pageContext.request.contextPath}/employee/changePassword">Đổi
						mật khẩu</a></li>
						...
						<div class="col-xs-14 col-sm-12 col-md-12">
							<div class="panel panel-warning">
								...
								<div class="panel-body">
									<form
										action="${pageContext.request.contextPath}/employee/resetPassword"
										method="POST">
										<label>Mật khẩu cũ</label> <input type="password"
											name="oldPass" class="form-control" value="${oldPass}" /> <label
											style="color: red; margin-top: 5px;">${errorOldPass}</label>
										<br> <label>Mật khẩu mới</label> <input type="password"
											name="newPass" class="form-control" value="${newPass}" /> <label
											style="color: red; margin-top: 5px;">${errorNewPass}</label>
										<br> <label>Nhập lại mật khẩu</label> <input
											type="password" name="confirmPass" class="form-control"
											value="${confirmPass}" /> <label
											style="color: red; margin-top: 5px; float: left; width: 100%;">${errorComfirmPass}</label>
										<button class="btn btn-success"
											style="margin-top: 5px; height: 42px; float: left;">Lưu</button>
									</form>
									<button class="btn btn-grey"
										style="margin-top: 5px; margin-left: 5px;" id="clear">Làm
										mới</button>
								</div>
							</div>
						</div>
