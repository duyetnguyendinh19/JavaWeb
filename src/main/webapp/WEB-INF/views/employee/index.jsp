				...
				<div class="col-sm-10 col-sm-offset-1">
					<div class="login-container">
						<div class="center">
							...
							<h4 class="blue" id="id-company-text">&copy; Quản lý nhân
								viên</h4>
						</div>
								...
								<div class="widget-body">
									<div class="widget-main">
										<h4 class="header blue lighter bigger">
											<i class="ace-icon fa fa-coffee green"></i> Vui lòng nhập
											thông tin đăng nhập
										</h4>
											...
											<fieldset>
												<label class="block clearfix"> <span
													class="block input-icon input-icon-right"> <input
														...
														placeholder="Tài khoản" /> <i class="ace-icon fa fa-user"
														style="width: 25px; margin-top: 9px; margin-right: 5px;"></i>
												</span>
												</label> <label class="block clearfix"> <span
													class="block input-icon input-icon-right"> <input
														type="password" class="form-control" name="password"
														placeholder="Mật khẩu" /> <i class="ace-icon fa fa-lock"
														style="width: 25px; margin-top: 9px; margin-right: 5px;"></i>
												</span>
												</label>
												...
												<div class="clearfix">
													<label class="inline"> <span
														style="cursor: pointer; margin-top: 5px; float: left; color: blue;"
