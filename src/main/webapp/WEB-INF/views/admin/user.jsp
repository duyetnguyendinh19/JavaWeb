                ...
                <div class="row">
                    <div class="col-xs-14 col-sm-12 col-md-11">
                        <div class="panel panel-warning">
                            ...
                            <form action="${pageContext.request.contextPath}/admin/listAccount" method="POST"
                                ...
                                <div class="row">
                                    <div class="col-12 col-sm-12 col-xs-12 col-md-12 col-lg-10">
                                        <label class="col-12 col-sm-3 col-xs-12  col-md-4 col-lg-2"
                                               style="margin-top: 8px;padding-left: 0px;">Tài khoản:</label>
                                        <input type="text" name="user"
                                               class="col-12 col-sm-9 col-xs-12  col-md-7 col-lg-5 tennv"
                                               placeholder="Tài khoản..." style="border-radius: 5px!important;
		" value="${nameSearch}"/>
                                        <button class="col-12 col-sm-2 col-xs-4  col-md-4 col-lg-2" type="submit"
                                                style="font-family: Tahoma">Tìm kiếm
                                        </button>
                                    </div>
                                </div>
                            </form>
