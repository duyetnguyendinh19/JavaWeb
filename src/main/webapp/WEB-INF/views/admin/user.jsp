				...
				<div class="row">
					<div class="col-xs-14 col-sm-12 col-md-11">
						<div class="panel panel-warning">
							...
							<form action="${pageContext.request.contextPath}/admin/listAccount" method="POST" style="float: left;padding: 16px;width: 50%;">
								<label>Tài khoản:</label>
								<input type="text" name="user" class="tennv" placeholder="Tên tài khoản..." style="border-radius: 5px!important;" value="${nameSearch}"/>
