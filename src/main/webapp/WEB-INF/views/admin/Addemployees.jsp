    ...
    <div class="row">
        <div class="col-xs-14 col-sm-12 col-md-11">
            <div class="panel panel-warning">
                ...
                <form:form modelAttribute="employee"
                    ...
                    <div clas="row">
                        <div class="col-md-3 mb-3" style="text-align: center;">
                            <div class="wrap-custom-file" style="margin-top: 15px;width: 200px;height: 180px">
                        ...
                        <div class="col-md-4 mb-3" style="margin-bottom: 30px;margin-top: 5px;">
                        ...
                        <div class="col-md-4 mb-3">
                            <label for="validationDefault3">Phòng ban</label> <br/>
                            <select name="idDepartment" class="ui dropdown">
                    ...
                    <div class="row" style="float:left;width: 100%;margin: 0px!important;margin-left: 22px!important;padding-right: 25px;">
                    ...
                    <div class="row" style="float:left;width: 85%;margin: 0px!important;margin-left: 22px!important;padding-bottom: 25px;">
                ...
                <a href="#">
                    <button style="margin-bottom: 10px;float:left;border-radius: 5px;margin-top:20px;"
                            class="btn btn-warning">Hủy bỏ
                    </button>
                </a>
            </div>
