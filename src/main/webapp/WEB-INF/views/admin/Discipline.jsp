				...
				<div class="row">
					<div class="col-xs-14 col-sm-12 col-md-11">
						<div class="panel panel-warning">
							...
							<form
								action="${pageContext.request.contextPath}/admin/listDiscipline"
							...
							<div class="panel-body">
									...
									<tbody>
										<c:forEach items="${disciplineList}" var="discipline"
											...
											<tr style="text-align: center;">
												...
												<td><a
													href="${pageContext.request.contextPath}/admin/updateDiscipline/${discipline.id}">
													...
													<button class="btn btn-danger" id="delete"
														onclick="loadModal('${discipline.employee.name}', '${discipline.id}')"
								...
								<div class="row">
									...
									<div class="col-6 col-sm-6 col-xs-4 col-md-6 col-lg-3">
										<a style="float: right;"> <label>View</label> <label>${firstDis}</label>
											<label>-</label> <label>${lastDis}</label> <label>of</label>
											<label>${totalDis}</label>
										</a>
									</div>
								</div>
								<div class="ui modal">
									<i class="close icon"></i>
									<div class="header">Xóa kỷ luật</div>
									<div class="content">
										<h4>
...
<script type="text/javascript">
			...
			.keypress(
					function(event) {
						...
						if (event.keyCode === 13) {
							if (number < 1) {
								window.location
										.assign("http://localhost:9999/Manager/admin/listDiscipline/" + 1);
							} else if (number > numbertotal) {
								window.location
										.assign("http://localhost:9999/Manager/admin/listDiscipline/"
												+ numbertotal);
							} else {
								window.location
										.assign("http://localhost:9999/Manager/admin/listDiscipline/"
	...
	function lastpage() {
		window.location.assign("http://localhost:9999/Manager/admin/listDiscipline/"
				+ numbertotal);
	}
