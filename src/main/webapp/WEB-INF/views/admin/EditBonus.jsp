        ...
        <div class="col-xs-14 col-sm-12 col-md-11">
            <div class="panel panel-warning">
                <div class="panel-heading">
                    <h2 class="panel-title">Sửa khen thưởng</h2>
                </div>
                <form action="${pageContext.request.contextPath}/admin/updateBonus" method="POST">
                    <input type="text" value="${bonus.employee.id}" name="employee" hidden="hidden"/>
                    <input type="text" value="${bonus.id}" name="id" hidden="hidden"/>
                    <div class="col-md-4 mb-6" style="margin-top: 15px;">
                        <label>Nhân viên</label>
                        <input type="text" class="form-control" value="${bonus.employee.id} - ${bonus.employee.name}"
                               readonly/>
                    ...
                    <div class="col-md-4 mb-3" style="margin-top: 15px;">
                        ...
                        <div class="ui calendar" id="rangestart">
                            <input type="text" class="form-control datepicker" id="startDate" readonly
                                   name="date" value="<fmt:formatDate pattern="MM/dd/yyyy"
                                                                value="${bonus.date}"/>"
                    ...
                    <div class="col-md-6 mb-3" style="margin-top: 15px;">
                        ...
                        <textarea rows="6" name="descent" placeholder="Mô tả khen thưởng"
                                  style="width: 100%;border-radius: 5px!important;padding: 10px;float:left;">${bonus.descent}</textarea>
                    ...
                    <div class="col-md-6 mb-3" style="margin-top: 15px;">
                        ...
                        <textarea rows="6" name="reason" placeholder="Lý do khen thưởng"
                                  style="width: 100%;border-radius: 5px!important;padding: 10px;">${bonus.reason}</textarea>
...
<script>
    $('#typeBonus').val('${bonus.type}').trigger('change');
</script>
<script>
